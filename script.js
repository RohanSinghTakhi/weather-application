/**
 * Object representing a weather application.
 */
let weather = {
  apiKey: "1be30e66339ca5d50db91dc547926743",
   ...
   * @param {Function} data - Weather data received from the API.
   */
  ...
  /**
   * weather search based on the input city.
   */
  search: function () {
...
// Fetch weather for Chandigarh on page load
